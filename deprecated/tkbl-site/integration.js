//window.talkablePlacementsConfig = {"placements":[{"id":230540,"inclusion_matcher":{"blank":true},"inclusion_matchers":[{"blank":true}],"exclusion_matchers":[],"event_category":"purchase","device_types":["desktop","tablet","mobile"],"appearance":"popup","static_html":[]},{"id":230541,"inclusion_matcher":{"host_pattern":null,"query_pattern":{},"path_pattern":"/share"},"inclusion_matchers":[{"host_pattern":null,"query_pattern":{},"path_pattern":"/share"}],"exclusion_matchers":[],"event_category":"affiliate_member","device_types":["desktop","tablet","mobile"],"appearance":"inline","static_html":[]},{"id":230542,"inclusion_matcher":{"blank":true},"inclusion_matchers":[{"blank":true}],"exclusion_matchers":[],"event_category":"affiliate_member","device_types":["desktop","tablet","mobile"],"appearance":"gleam","static_html":[]},{"id":230543,"inclusion_matcher":{"blank":true},"inclusion_matchers":[{"blank":true}],"exclusion_matchers":[],"event_category":"affiliate_member","device_types":["desktop","tablet","mobile"],"appearance":"widget","static_html":[]}],"loyalty_placements":[{"id":230546,"inclusion_matcher":{"regexp":"extra_placement=true"},"inclusion_matchers":[{"regexp":"extra_placement=true"},{"host_pattern":null,"query_pattern":{},"path_pattern":"/signup.html"},{"host_pattern":null,"query_pattern":{},"path_pattern":"/loyalty.html"}],"exclusion_matchers":[{"regexp":"test-12345"}],"event_category":"loyalty_dashboard","device_types":["desktop","tablet"],"appearance":"widget","static_html":[]},{"id":230544,"inclusion_matcher":{"blank":true},"inclusion_matchers":[{"blank":true}],"exclusion_matchers":[{"regexp":"not_shown=true"},{"host_pattern":null,"query_pattern":{},"path_pattern":"/signup_3.html"},{"host_pattern":null,"query_pattern":{},"path_pattern":"/not_shown=true2"}],"event_category":"loyalty_dashboard","device_types":["desktop","tablet","mobile"],"appearance":"widget","static_html":[]},{"id":230545,"inclusion_matcher":{"regexp":"widget_2=true"},"inclusion_matchers":[{"regexp":"widget_2=true"}],"exclusion_matchers":[{"regexp":"show_widget=false"}],"event_category":"loyalty_widget","device_types":["desktop","tablet","mobile"],"appearance":"widget","static_html":[]}],"integration_id":"testmax-loyalty-13oct2021","site_url":"http://learn.talkable.com/QA-Max/void/loyalty-placements","timestamp":1636545884};
...
var talkable = window.talkable = function() {
  ...
  var utils = {
    ...
    matchLoyaltyPlacements: function() {
      var placementIds = utils.match_placements('loyalty_dashboard', talkablePlacementsConfig.loyalty_placements);
      if (placementIds !== EMPTY_PLACEMENTS) {
        return { matchedPlacementIds: placementIds, path: '/loyalty/show' };
      }

      placementIds = utils.match_placements('loyalty_widget', talkablePlacementsConfig.loyalty_placements);
      if (placementIds !== EMPTY_PLACEMENTS) {
  ...
  var methods = {
    ...
    show_loyalty: function(data) {
      ...
      utils.formIframe(options, matchData.path, {
        ...
        campaign_id: utils.location_parameter('tkbl_campaign_id') || registerData.campaign_id,
        first_name: first_name,
        last_name: last_name,
        matched_placement_ids: registerData.matched_placement_ids || matchData.matchedPlacementIds,
      });
    },

    // backward compatibility
    show_loyalty_redeem_widget: function(data) {
      methods.show_loyalty(data);
    },
