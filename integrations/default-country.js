    ...
    var talkable = (window.talkable = (function () {
      ...
      var utils = {
        ...
        launchCampaigns: function () {
          ...
          var showMultiGeoCampaigns = utils.location_parameter('matched_country_ids');
  
          if (
            showCampaignCondition ||
            showMultiGeoCampaigns ||
      ...
      methods = {
        ...
        register_affiliate: function (data) {
          ...
          var parameters = {
            ...
            matched_country_ids:
              utils.location_parameter('matched_country_ids') ||
              registerData.matched_country_ids ||
              utils.matchedCountries,
