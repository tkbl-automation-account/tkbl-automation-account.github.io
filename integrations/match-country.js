...
(function (window, document, JSON, Object) {
  ...
  var talkable = (window.talkable = (function () {
    ...
    var utils = {
      ...
      injectPassInstallMeta: function (passInstallUrl) {
        ...
        meta.setAttribute('content', "0;URL='" + passInstallUrl + "'");
      ...
      launchCampaigns: function () {
        ...
        var showCampaignCondition =
          ...
          utils.location_parameter('tkbl_country_code');
      ...
      addIframeElement: function (url, options) {
        ...
        utils.subscribe('force_pass_install_load', iframe.name, function (data) {
          if (data.pass_install_url) {
            utils.injectPassInstallMeta(data.pass_install_url);
          }
        });
    ...
    methods = {
      ...
      register_affiliate: function (data) {
        ...
        var parameters = {
          ...
          tkbl_country_code:
            utils.location_parameter('tkbl_country_code') ||
            registerData.tkbl_country_code,
